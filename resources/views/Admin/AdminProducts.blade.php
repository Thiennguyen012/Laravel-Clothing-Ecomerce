    ...
    <div class="mb-6">
        ...
        <form method="GET" action="" class="flex flex-wrap items-end gap-4">
            ...
            <div>
                ...
                <input type="text" name="product_name" id="product_name" value="{{ request('product_name') }}" class="border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 min-w-[180px] px-3 py-2" placeholder="Tên sản phẩm">
            </div>
