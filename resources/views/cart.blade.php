                                        ...
                                        <div class="flex items-center justify-between p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <h3 class="text-lg font-medium text-gray-900 vietnamese-text">
                                                    ...
                                                    <p class="text-lg font-semibold text-blue-600 vietnamese-text">
                    ...
                    @else
                        ...
                        <div class="flex items-center justify-center min-h-[400px]">
                            <div class="text-center max-w-sm">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-2 vietnamese-text">Giỏ hàng trống</h3>
                                <p class="text-base text-gray-500 mb-6 vietnamese-text">Bạn chưa có sản phẩm nào trong giỏ hàng.</p>
                                <a href="{{ route('products') }}" class="inline-flex items-center px-5 py-2.5 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 vietnamese-text transition-colors duration-200">
    ...
    <div id="deleteConfirmModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50 flex items-center justify-center">
        <div class="relative mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900 mt-4 vietnamese-text">Xác nhận xóa sản phẩm</h3>
                ...
                <div class="items-center px-4 py-3">
                    <button onclick="confirmDelete()" class="px-4 py-2 bg-red-500 text-white text-base font-medium rounded-md w-24 shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-300 mr-2 vietnamese-text">
                        Xóa
                    </button>
                    <button onclick="closeDeleteModal()" class="px-4 py-2 bg-gray-500 text-white text-base font-medium rounded-md w-24 shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300 vietnamese-text">
                        Hủy
                    </button>
                </div>
            </div>
